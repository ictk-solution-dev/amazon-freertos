...
#ifdef ICTK_AWS_IOT
#define AWS_IOT_TASK_NAME               "AWS_IOT"
#define AWS_IOT_TASK_STACKSIZE          (1024 * 20)//(1024 * 12)

#endif

#ifdef ICTK_ZTP
#define AWS_ZTP_TASK_NAME               "ZTP"
#define AWS_ZTP_TASK_STACKSIZE          (1024 * 20)//(1024 * 12)
#endif

#ifdef ICTK_WIFI
#define AWS_WIFI_TASK_NAME               "AWS_WIFI"
#define AWS_WIFI_TASK_STACKSIZE          (1024 * 20)//(1024 * 12)
#endif

#ifdef AMADAS_DOOR_LOCK
#define ADL_TASK_NAME                   "ADL_IOT"
#define ADL_TASK_STACKSIZE              (1000*4)
