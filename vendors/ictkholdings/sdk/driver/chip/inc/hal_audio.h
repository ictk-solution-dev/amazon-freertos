...
typedef enum {
    ...
    HAL_AUDIO_EVENT_TIME_REPORT         =  5, /**<  Report the timestamp and smaple for BT audio sync. */
    HAL_AUDIO_EVENT_LTCS_REPORT         =  6, /**<  Report A2DP LTCS data. */
    HAL_AUDIO_EVENT_DL_REINIT_REQUEST   =  7, /**<  Request to re-init downlink path for BT audio sync. */
    HAL_AUDIO_EVENT_HFP_PARA_SEND       =  8, /**<  [HFP] DSP Request to send parameter from agent to partner. */
    HAL_AUDIO_EVENT_ALC_REQUEST         =  9, /**<  [A2DP] Active Latency control. */
} hal_audio_event_t;
...
typedef enum {
    ...
    HAL_AUDIO_CHANNEL_DUMMY         = 0x7FFFFFFF,   /**<  Dummy for DSP structrue alignment */
...
typedef enum {
    ...
    HAL_AUDIO_MEM_DUMMY             = 0x7FFFFFFF,   /**<  Dummy for DSP structrue alignment */
} hal_audio_memory_t;
...
typedef enum {
    ...
    HAL_AUDIO_INTERFACE_DUMMY       = 0x7FFFFFFF,   /**<  Dummy for DSP structrue alignment */
...
typedef enum {
    ...
    AFE_PCM_FORMAT_LAST,
    AFE_PCM_FORMAT_DUMMY            = 0x7FFFFFFF,   /**<  Dummy for DSP structrue alignment */
} hal_audio_format_t;
...
/** @brief audio structure */
typedef struct {
    void*                       user_data;              /**< User data provied by user*/
    ...
    uint32_t                    channel;                /**< Stream out datat channel*/
 ...
 * @param[in] samplerate is a index to determine which APLL need to Enable/Disable.
 * @return    #HAL_AUDIO_STATUS_OK, if OK.
 * @par       Example
