...
typedef enum {
    HAL_AES_KEY_SOURCE_EFUSE1  = 0,        /**< FUSE KEY0 */
    HAL_AES_KEY_SOURCE_EFUSE2  = 1,        /**< FUSE KEY1 */
    HAL_AES_KEY_SOURCE_NUM     = 2
} hal_aes_key_src;
...
/**
 * @brief     This function provides AES encryption in EBC mode.
 * @param[out] encrypted_text is the target encrypted text.
 * @param[in]  plain_text is the source plain text.
 * @param[in]  key is the AES encryption key.
 * @return     #HAL_AES_STATUS_OK, if the operation completed successfully.
...
/**
 * @brief     This function provides AES decryption in EBC mode.
 * @param[out] plain_text is the target plain text.
 * @param[in]  encrypted_text is the source encrypted text.
 * @param[in]  key is the AES encryption key.
 * @return     #HAL_AES_STATUS_OK, if the operation completed successfully.
...
/**
 * @brief     This function provides an AES encryption in EBC mode with using
 *            hardware encryption key in eFUSE.
 * @param[out] encrypted_text is the target encrypted text.
 * @param[in]  plain_text is the source plain text.
 * @param[in]  key is used to pass the key information which are key.length and key.buffer is not used.
...
/**
 * @brief     This function provides an AES decryption in EBC mode with using
 *            hardware encryption key in eFUSE.
 * @param[out] plain_text is the target plain text.
 * @param[in]  encrypted_text is the source encrypted text.
 * @param[in]  key is used to pass the key information which are key.length and key.buffer is not used.
