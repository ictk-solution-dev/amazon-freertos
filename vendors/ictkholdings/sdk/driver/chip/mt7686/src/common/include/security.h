...
/**
*@brief This function to read efuse_key0 and efuse_key1 from eFuse
 * @param[in]  pointer to buffer used to store efuse_key
 * @param[in]  choose the efuse_key0 or efuse_key1
*@return void
*/
void security_efuse_key(uint8_t *efuse_key, uint8_t key_src);
