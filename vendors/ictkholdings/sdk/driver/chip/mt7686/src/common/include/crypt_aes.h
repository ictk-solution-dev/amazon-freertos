...
#define AES_KEY_SOURCE_EFUSE1   (0)
#define AES_KEY_SOURCE_EFUSE2   (1)
#define AES_KEY_SOURCE_NUM      (2)

#define AES_KEY_SLOT_0 (0)
#define AES_KEY_SLOT_1 (1)
...
/**
 * @brief  The function set the key slot
 *
 * @param  slot [IN] select the key slot for key source
 *
 * @return >=0 means success, <0 means fail.
 *
 * @note If key source set as from efuse, corresponding efuse value has to be configured by efuse setting function.
