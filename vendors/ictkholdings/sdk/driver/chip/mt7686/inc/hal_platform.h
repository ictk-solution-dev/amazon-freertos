...
#define HAL_SHA_FEATURE_POLLING_ENABLED            /* Supports polling mode in SHA module */
#endif
 ...
 *  The platform supports a total of 23 GPIO pins with various functionality.
 *
*/
...
typedef enum {
    HAL_GPIO_CLOCK_MODE_32K = 0,        /**< 32KHz */
    HAL_GPIO_CLOCK_MODE_FXO = 1,        /**< if XO clock is 40MHz, output 20MHz. If XO is 26MHz, output 26MHz*/
    HAL_GPIO_CLOCK_MODE_24M = 2,        /**< 24MHz,divided from BBPLL2 (960MHz/40 = 24MHz)*/
    HAL_GPIO_CLOCK_MODE_48M = 3,        /**< 48MHz,divided from BBPLL2 (960MHz/20 = 48MHz) */
    HAL_GPIO_CLOCK_MODE_2M  = 4,        /**< 2MHz, divided from fxo (20MHz/10 = 2MHz or 26MHz/13 = 2MHz) */
    HAL_GPIO_CLOCK_MODE_40M = 5,        /**< 40MHz,divided from BBPLL2 (960MHz/24 = 40MHz) */
    HAL_GPIO_CLOCK_MODE_XPLL = 6,       /**< 24.576MHz or 22.5792MHz (by I2S required setting) */
    HAL_GPIO_CLOCK_MODE_XO_BBTOP = 7,   /**< 40Mhz or 26Mhz, it's depend on XO clock*/
...
typedef enum {
    ...
    HAL_GPT_3 = 3,                          /**< GPT port 3. Used for as software GPT. The clock source is 32Khz. */
    HAL_GPT_4 = 4,                          /**< GPT port 4. Used for set a millisecond delay and get 1/32Khz free count. The clock source is 32Khz. */
    HAL_GPT_5 = 5,                          /**< GPT port 5. Used for set a microsecond delay and get microsecond free count. The clock source is 1Mhz. */
...
typedef enum {
    ...
    HAL_PWM_CLOCK_MAX,                      /**< The total number of PWM clock. */
