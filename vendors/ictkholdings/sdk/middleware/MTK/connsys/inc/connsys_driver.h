...
#define WIFI_HIF_TX_PORT0_IDX                   0   /* in-band command port */
#define WIFI_HIF_TX_PORT1_IDX                   1   /* data port */
...
#define CONNSYS_STATUS_INVALID_PARAMETER    (-2)
#define CONNSYS_STATUS_WRONG_STATE          (-3)
#define CONNSYS_STATUS_DMA_FAILURE          (-4)
...
#define CONNSYS_SW_RST 0xA2090024
#define N9ROM_INIT_DONE 0xc00c1254
#endif
#if (PRODUCT_VERSION == 7698 || PRODUCT_VERSION == 7686 || PRODUCT_VERSION == 7682 || PRODUCT_VERSION == 5932)
#define WF_PSE_TOP_BASE 0xD0000000
#else
...
#define PSE_RSV_CNT         (WF_PSE_TOP_BASE + 0x13C)
...
typedef int (*raw_handler_t)(unsigned char *payload, unsigned int len);
typedef void (*connsys_ctl_raw_t)(raw_handler_t handler);

struct connsys_callback_func {
    connsys_allocate_pkt_t  allocate_pkt_callback;
    connsys_input_pkt_t     input_pkt_callback;
    connsys_ctl_raw_t   ctl_raw_callback;
};
struct connsys_func {
...
void connsys_register_ctl_raw_callback(connsys_ctl_raw_t func);
...
//N9 CR 0x81021258 mapping to the CM4  is 0xC00C1258,this is information for n9 about setting xtal option
#define AON_TOP_AON_RSV2 ((volatile uint32_t *)(0xC00C1258))
#define XTAL_COMPILER_OPTION_TRAPPING_MASK 0x1
#define XTAL_COMPILER_OPTION_TRAPPING_SHIFT 1
#define XTAL_COMPILER_OPTION_XO_MASK 0xF
#define XTAL_COMPILER_OPTION_XO_SHIFT 2
#define XTAL_COMPILER_OPTION_CK_MASK 0x1
#define XTAL_COMPILER_OPTION_CK_SHIFT 6
#define IS_External_32K (((*(volatile uint32_t *)(0xA2010040)) & 0x20) == 0)
