...
#define WIFI_FW_ADDR_IN_FLASH   (FLASH_BASE + N9_RAMCODE_BASE) //  0x10000000 is used for cache (XIP)
#else
...
//#else
/* MT7686/82/32 */
//#define WIFI_FW_ADDR_IN_FLASH   (FLASH_BASE + N9_RAMCODE_BASE) 
#endif
...
#define WIFI_CONNSYS_CLI_ENTRY { "connsys",    "connsys related cmd",    connsys_entry_cli },
#else
#define WIFI_CONNSYS_CLI_ENTRY
#endif

#if 0
//for data path timestamp debug
void connsys_record_time_stamp(uint8_t record_seq);
void connsys_print_record_time_stamp(void);
#endif
