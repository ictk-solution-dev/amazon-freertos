...
ifeq ($(MTK_NVDM_ENABLE),n)
$(error  "Check feature dependency: MTK_WIFI_PROFILE_ENABLE enable need MTK_NVDM_ENABLE enable also")
endif
endif

ifeq ($(MTK_WIFI_DHCPD_DHCP_COEXIST_ENABLE),y)
ifeq ($(MTK_WIFI_REPEATER_ENABLE),n)
$(error  "Check feature dependency: MTK_WIFI_DHCPD_DHCP_COEXIST_ENABLE enable need MTK_WIFI_REPEATER_ENABLE enable also")
endif
endif
...
C_FILES  += $(WIFI_SERVICE_SRC)/src/single_rate_test.c
...
C_FILES  += $(WIFI_SERVICE_SRC)/src/wifi_bwcs_porting.c
