...
/**
* @brief Example of Set mgmt_ac3 enable/disable
* @param [IN]onoff  0: disable, 1: enable
* @return  >=0 means success, <0 means fail
* @note Only MT7697 support this, for Xiami
* 
* \n Example of cli usage
* \n <b>cli_format</b>:    wifi config set mgmt_ac3 <on_off>
* \n <b>cli_param</b>:     on_off:  0: disable;  1: enable
*
* \n <b>cli_example</b>:   wifi config set mgmt_ac3 1 
* \n <b>cli_note</b>:      mgmt_ac3 will be turn on.
*
*/
uint8_t wifi_config_set_mgmt_ac3_on_ex(uint8_t len, char *param[]);

/**
* @brief Example of Get mgmt_ac3 enable/disable
* @param [OUT]onoff  0: disable, 1: enable
* @return  >=0 means success, <0 means fail
* @note Only MT7697 support this, for Xiami
* 
* \n Example of cli usage
* \n <b>cli_format</b>:    wifi config get mgmt_ac3
* \n <b>output</b>:         on_off:  0: disable;  1: enable
*
* \n <b>cli_example</b>:   wifi config get mgmt_ac3
* \n <b>cli_note</b>:      Get the current status of mgmt_ac3.
*
*/
uint8_t wifi_config_get_mgmt_ac3_on_ex(uint8_t len, char *param[]);

/**
* @brief Example of Set tmac_trcr enable/disable
* @param [IN]onoff  0: disable, 1: enable
* @return  >=0 means success, <0 means fail
* @note Only MT7697 support this, for Xiami
* 
* \n Example of cli usage
* \n <b>cli_format</b>:    wifi config set tmac_trcr <on_off>
* \n <b>cli_param</b>:     on_off:  0: disable;  1: enable
*
* \n <b>cli_example</b>:   wifi config set tmac_trcr 1 
* \n <b>cli_note</b>:      tmac_trcr will be turn on.
*
*/
uint8_t wifi_config_set_tmac_trcr_on_ex(uint8_t len, char *param[]);

/**
* @brief Example of Get tmac_trcr enable/disable
* @param [OUT]onoff  0: disable, 1: enable
* @return  >=0 means success, <0 means fail
* @note Only MT7697 support this, for Xiami
* 
* \n Example of cli usage
* \n <b>cli_format</b>:    wifi config get tmac_trcr
* \n <b>output</b>:         on_off:  0: disable;  1: enable
*
* \n <b>cli_example</b>:   wifi config get tmac_trcr
* \n <b>cli_note</b>:      Get the current status of tmac_trcr.
*
*/
uint8_t wifi_config_get_tmac_trcr_on_ex(uint8_t len, char *param[]);

#if defined(MTK_WIFI_WPS_ENABLE)
/**
* @brief Example of wps terminate connect.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:   wifi config set termin_connect <port>
* \n <b>cli_param</b>:   port:  0:STA mode
*
* \n <b>cli_example</b>: wifi config set wps_termin_connect 0
* \n <b>cli_note</b>: terminate the sta wps connect process
*
*/
uint8_t wifi_config_wps_terminate_connect_ex(uint8_t len, char *param[]);
#endif

/**
* @brief Example of eFEM config.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:   wifi config set eFEM SKY85329-11/SKY85331-11
*
*/
uint8_t wifi_config_set_efem_ex(uint8_t len, char *param[]);
