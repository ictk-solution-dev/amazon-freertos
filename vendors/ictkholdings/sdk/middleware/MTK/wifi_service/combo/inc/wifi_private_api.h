...
typedef enum {
    WIFI_ANT_SELECT_INDEX_0,                /* Antenna select index 0, the GPIO should configure the corresponding pinmux mode.*/
    WIFI_ANT_SELECT_INDEX_1,                /* Antenna select index 1, the GPIO should configure the corresponding pinmux mode.*/
    WIFI_ANT_SELECT_INDEX_2,                /* Antenna select index 2, the GPIO should configure the corresponding pinmux mode.*/
    WIFI_ANT_SELECT_INDEX_3,                /* Antenna select index 3, the GPIO should configure the corresponding pinmux mode.*/
    WIFI_ANT_SELECT_INDEX_4,                /* Antenna select index 4, the GPIO should configure the corresponding pinmux mode.*/
    WIFI_ANT_SELECT_INDEX_MAX
}ant_sel_index_t;

typedef enum {
    ANT_SELECT_MODE_PHY_RF_SW_TX = 2,            /* The configured singnal relevant to Wi-Fi RF TX singal.*/
    ANT_SELECT_MODE_PHY_RF_SW_RX = 3,            /* The configured singnal relevant to Wi-Fi RF RX singal.*/
    ANT_SELECT_MODE_PHY_RF_SW_TX_INVERSE = 4,    /* The configured singnal relevant to the inverse of Wi-Fi RF TX singal.*/
    ANT_SELECT_MODE_PHY_RF_SW_RX_INVERSE = 5,    /* The configured singnal relevant to the inverse of Wi-Fi RF RX singal.*/
    ANT_SELECT_MODE_PHY_RF_EXT_LNA = 6,          /* The configured singnal relevant to the use of external LNA singal.*/
    ANT_SELECT_MODE_PHY_RF_EXT_LNA_INVERSE = 8,  /* The configured singnal relevant to the inverse of external LNA singal.*/
    ANT_SELECT_MODE_BT_TX_RX = 10,               /* The configured singnal relevant to BT TX/RX singal.*/
    ANT_SELECT_MODE_BT_TX_RX_INVERSE = 11        /* The configured singnal relevant to the inverse of BT TX/RX singal.*/
}ant_sel_mode_t;
...
*
* @note    Same as #wifi_config_set_bandwidth_extended
*/
...
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
* @note    In 7682/7682, supported in STA mode. 
*          In 7687/7697, supported in STA/AP mode.
*/
...
* @param [in]frame_type supported type see below
*
* Value                   |Definition                                                              |
* --------------------|------------------------------------------------------------------|
* \b MGMT_PKT_FILTER_ASSOC_REQ        | (0x1 << 0) |
* \b MGMT_PKT_FILTER_ASSOC_RESP       | (0x1 << 1) |  
* \b MGMT_PKT_FILTER_REASSOC_REQ      | (0x1<<2) |
* \b MGMT_PKT_FILTER_REASSOC_RESP  | (0x1<<3) |
* \b MGMT_PKT_FILTER_PROBE_REQ        | (0x1 << 4) |
* \b MGMT_PKT_FILTER_PROBE_RESP       | (0x1 <<5) |
* \b MGMT_PKT_FILTER_BEACON           | (0x1<<8) |
* \b MGMT_PKT_FILTER_ATIM             | (0x1<<9) |
* \b MGMT_PKT_FILTER_DEASSOC          | (0x1<<10) |
* \b MGMT_PKT_FILTER_AUTH             | (0x1 << 11) |
* \b MGMT_PKT_FILTER_DEAUTH           | (0x1<<12) |
*
* @param [in]vender_ie vender IE information,refer to #extra_vender_ie_t
*
* @return  >=0 means success, <0 means fail
*
* @note  1.One or more flag bits can be set at the same time
*        Ex: if frame_type=10  (bit 0,1 be set),   the ASSOC_REQ , REASSOC_RESP  frame can be sent to CM4 from N9 
*        if their IE are match with the data specified in  extra_ie_t,
*/
...
*
* @param [in]filter_switch enable/disable filter_switch
* @param [in]frame_type see frame_type in #wifi_config_set_frame_filter 
* @param [in]vender_ie vender IE information,refer to #extra_vender_ie_t
*
* @return  >=0 means success, <0 means fail
*/
...
* @return  >=0 means success, <0 means fail
*
* @note  Only supported in AP/Monitor mode
*/
...
* @return  >=0 means success, <0 means fail
*
* @note  Only supported in 7687/7697 and STA/AP mode .
*/
...
* @return  >=0 means success, <0 means fail
*
* @note  The support list is same as #wifi_config_set_ip_mac_port_filter .
*/
...
* @return  >=0 means success, <0 means fail
*
* @note  The support list is same as #wifi_config_set_ip_mac_port_list_entry .
*/
...
*
* @note   The user set power value(power) and really value set to hardware(dbm) have this Calculation formula: dbm = (power-127)/2. \n
*             Also the target tx power is limited by hardware performance. Maybe you set a maximum, but it can reached beacuse of hardware. 
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*/
...
/**
* @brief This function get mac adddress from register
*
* @param [in]port
...
* @return  >=0 means success, <0 means fail
*
* @note  Only supported in 5932/7682/7686 STA/AP/Repeater/Monitor mode
*/
...
* @return  >=0 means success, <0 means fail
*
* @note Only supported in 7687/7697 in STA mode. If it connected to an AP router, PHY rate also will be supported.
*/
...
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
* @note 1.  Only supported in 7682/7686/7687/7697 STA/AP/Repeater mode.
* @note 2.  If HT40 is enable, there have Primary Channel, Secondary Channel and Center channel. The singleSKU table power is used for Center channel.
* Please refer to <a href="https://en.wikipedia.org/wiki/IEEE_802.11n-2009#40%C2%A0MHz_channels_in_2.4%C2%A0GHz">introduction to center channel in Wikipedia</a>. \n
* For Example: When the device works in 40Mhz bandwidth with the center channel 3,  the 3rd row of single SKU power table are used. \n
* When the device works in 20Mhz bandwidth with the channel 1,  the 1st row of single SKU power table are used.
*/
...
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
* @note  Only supported in 7687/7697 STA/AP/Repeater mode.
*/
...
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
* @note  Only supported in 7697 STA/AP/Repeater mode.
*/
...
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
* @note  Same as #wifi_config_set_single_sku_5G .
*/
...
/**
* @brief This function set the pse use ac3 queue
*
* @param[in]  0 disable, 1 enable
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*/
int32_t wifi_config_set_ac3_enable(uint8_t enable);

/**
* @brief This function get the status whether the pse use ac3 queue
*
* @param[out]  0 disable, 1 enable
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*/
int32_t wifi_config_get_ac3_enable(uint8_t* enable);


/**
* @brief This function set the flow control threshold
*
* @param[in]  
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*/
int32_t wifi_config_set_flow_control_threshold(uint8_t low, uint8_t high);


/**
* @brief This function get the flow control threshold
*
* @param[out]  
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*/
int32_t wifi_config_get_flow_control_threshold(uint8_t* low, uint8_t* high);
...
/**
* @brief This function is used to get dwell time for scan.
*
* @param[in] scan_mode 0: active, 1: passive
* @param[in] dwell_time
*
...
/**
* @brief This function set the pse  use ac3 queue for MGMT
*
* @param[in]  0 disable, 1 enable
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
*/
int32_t wifi_config_set_mgmt_ac3_enable(uint8_t enable);

/**
* @brief This function get the status whether the pse  use ac3 queue for MGMT
*
* @param[out]  0 disable, 1 enable
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
*/
int32_t wifi_config_get_mgmt_ac3_enable(uint8_t* enable);

/**
* @brief This function set the TMAC_TRCR enable/disable
*
* @param[in]  0 disable, 1 enable
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
*/
int32_t wifi_config_set_tmac_trcr_enable(uint8_t enable);

/**
* @brief This function get the TMAC_TRCR enable/disable status
*
* @param[out]  0 disable, 1 enable
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
*/
int32_t wifi_config_get_tmac_trcr_enable(uint8_t* enable);

#ifdef MTK_WIFI_WPS_ENABLE
/**
* @brief This function terminate the wps connect process.
...
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support STA mode
*/
int32_t wifi_wps_terminate_connect(int32_t port);
#endif

/**
* @brief This function configure the antenna select function.

* @param[in] index is the index of antenna select function, please refer to #ant_sel_index_t.
*
* @param[in] mode is the mode of antenna select, please refer to #ant_sel_mode_t.
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note this function must be invoked only after #wifi_init().
* the pinmux mode should be configure conrrectly before call #wifi_config_set_ant_select_mode().
* As an example for coex in AW7698/MT7686/MT5932/MT7682:
* if you set the GPIO pinmux mode as WIFI_ANT_SEL1 in EPT configuration in user project for BT&Wi-Fi coexistence,
* user need configure antenna select singal as #ANT_SELECT_MODE_BT_TX_RX by invoking below API and parameter:
* wifi_config_set_ant_select_mode(WIFI_ANT_SELECT_INDEX_1,ANT_SELECT_MODE_BT_TX_RX)
*/
int32_t wifi_config_set_ant_select_mode(ant_sel_index_t index, ant_sel_mode_t mode);
