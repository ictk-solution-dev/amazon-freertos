...
/*Because of nvdm limited, the max len is 1024,
* SingleSKU2G string size is 14x19x3 chars = 798, 
* SingleSKU5G string size is 14x17x3 chars = 714.*/
#define PROFILE_BUF_SKU_LEN (1024)
#endif
