...
#endif
    int32_t (*wifi_get_scan_round)(void);
    int32_t (*wifi_get_pmk_info_ap)(uint8_t *pmk,uint8_t *ssid,uint8_t ssid_len, uint8_t *psk, uint8_t psk_len);
} wifi_init_callback;
...
void wifi_stack_set_tx_power_bin(uint32_t *tx_power_bin_addr);
