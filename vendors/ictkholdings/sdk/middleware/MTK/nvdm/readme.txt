...
Usage:          GCC: Please add "include $(SOURCE_DIR)/middleware/MTK/nvdm/module.mk" in your GCC project Makefile, and configure "MTK_NVDM_ENABLE = y" on specified GCC/feature.mk.
