...
int subscribe_publish_cpp_sample_main(void) {
...
//	parseInputArgsForConnectParams(argc, argv);
	...
	IOT_INFO("\nSubscribe Publish CPP Sample .... AWS IoT SDK Version %d.%d.%d-%s\n", VERSION_MAJOR, VERSION_MINOR, VERSION_PATCH, VERSION_TAG);

	mqttInitParams.enableAutoReconnect = false; // We enable this later below
	mqttInitParams.pHostURL = AWS_IOT_MQTT_HOST;
	mqttInitParams.port = AWS_IOT_MQTT_PORT;
	mqttInitParams.pRootCALocation = AWS_IOT_ROOT_CA_CERT;
	mqttInitParams.pDeviceCertLocation = AWS_IOT_DEVICE_CERT;
	mqttInitParams.pDevicePrivateKeyLocation = AWS_IOT_PRIVATE_KEY;
