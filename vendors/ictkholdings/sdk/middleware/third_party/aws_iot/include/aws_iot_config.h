...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "A2QXXJ6MMJDSGY.iot.us-east-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "18e4r_6437" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "TestDevice" ///< Thing Name of the Shadow this device is associated with
...
/// ZNT
#define MAX_SIZE_OF_PAYLOAD               300 /// Temporary : under of AWS_IOT_MQTT_[T|R]X_BUF_LEN (512)
#define MAX_SIZE_OF_KEY                   20  /// Temporary :
#define MAX_SIZE_OF_VALUE                 30  /// Temporary :
...
#define _AWS_IOT_PLATFORM_FREERTOS_

/* Topic to publish on */
#define INTEGRATION_TEST_TOPIC "test_device/159357258456"

/* Client ID to be used for single client tests */
#define INTEGRATION_TEST_CLIENT_ID "18e4r_4800"
