...
#define IOT_DEBUG(...)    LOG_I(common, __VA_ARGS__)
	/*{\
...
#define FUNC_ENTRY LOG_I(common, "FUNC_ENTRY:   %s L#%d \n", __func__, __LINE__);
#define FUNC_EXIT LOG_I(common, "FUNC_EXIT:   %s L#%d \n", __func__, __LINE__);
#define FUNC_EXIT_RC(x) { LOG_I(common, "FUNC_EXIT:   %s L#%d Return Code : %d \n", __func__, __LINE__, x); return x; }
#else
#define FUNC_ENTRY
...
#define IOT_INFO(...) LOG_I(common, __VA_ARGS__);
#else
#define IOT_INFO(...)
#endif
...
#define IOT_WARN(...) {LOG_I(common, "WARN:  %s L#%d ", __func__, __LINE__); LOG_I(common, __VA_ARGS__);}
#else
#define IOT_WARN(...)
#endif
...
#define IOT_ERROR(...)  {LOG_I(common, "ERROR:  %s L#%d ", __func__, __LINE__);LOG_I(common, __VA_ARGS__); }
#else
#define IOT_ERROR(...)
#endif
