...
/* SSL options */
#define MBEDTLS_SSL_MAX_CONTENT_LEN             (6 * 1024) //16384 /**< Maxium fragment length in bytes, determines the size of each of the two internal I/O buffers */
 ...
 */
#define MBEDTLS_SSL_CIPHERSUITES MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256//,MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384
