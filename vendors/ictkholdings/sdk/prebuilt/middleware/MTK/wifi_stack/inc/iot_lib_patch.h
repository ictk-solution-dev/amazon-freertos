...
#endif
#if (MT7682_WSAP00041741==1)
#define RTMP_SET_TX_FLOW_CONTOL_FAILED(_p,_bit)		(RTPKT_TO_OSPKT(_p)->cb[CB_OFF+18]|= _bit)   
#define RTMP_GET_TX_FLOW_CONTOL_FAILED(_p)			(RTPKT_TO_OSPKT(_p)->cb[CB_OFF+18])
#define TX_FLOW_CONTOL_FAILED_OFFSET 				 CB_OFF+18
#define TX_FLOW_CONTOL_FAILED_SET 					 BIT(1)
#endif
...
#define KEY_ID_NUM 4//Max number of KeyIDs
