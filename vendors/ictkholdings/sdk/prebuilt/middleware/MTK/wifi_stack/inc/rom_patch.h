...
typedef enum _IOT_CONFIG_FREE_OUI_SUBTYPE {
    IOT_CONFIG_FREE_SUBTYPE_REQ = 1,
	IOT_CONFIG_FREE_SUBTYPE_RSP = 2,
} IOT_CONFIG_FREE_OUI_SUBTYPE;

#define IOT_CONFIG_FREE_OUI_TYPE	0x01

extern CF_IE g_CF_IE;

void ConfigFreeInit();
void ConfigFreeStart(PUCHAR nonce);
void ConfigFreeStop();
int ConfigFreeCheck( IN PRTMP_ADAPTER pAd, IN MLME_QUEUE_ELEM *Elem, IN IOT_CONFIG_FREE_OUI_SUBTYPE check_type /* 0: req, 1: rsp */ );
#endif /* MT7687_BORA00006139 */
