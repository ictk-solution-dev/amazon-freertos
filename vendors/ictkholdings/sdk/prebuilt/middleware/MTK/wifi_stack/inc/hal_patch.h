...
#define LPAON_DBG               (WIFI_LPAON_BASE + 0x001C)
#define LPAON_SMCTL8            (WIFI_LPAON_BASE + 0x0068)
#define LPAON_DUMMY1            (WIFI_LPAON_BASE + 0x0070)

#define LP_WISR5			(WIFI_INT_BASE + 0x0064)
#define LP_WIER5			(WIFI_INT_BASE + 0x0068)
#define LP_HCTLR			(WIFI_INT_BASE + 0x006C)
#define LP_HWISR5			(WIFI_INT_BASE + 0x0070)
#define LP_HWIER5			(WIFI_INT_BASE + 0x0074)
