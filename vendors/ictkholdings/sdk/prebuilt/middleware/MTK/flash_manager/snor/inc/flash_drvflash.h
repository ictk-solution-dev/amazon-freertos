...
typedef struct {
    ...
    int32_t     (*LockEraseBlkAddr)   (void *DriveData, void *Address, uint32_t Action);
...
///[Qinghua]
///TODO::: change task and semaphore
///TODO::  [Qinghua]
