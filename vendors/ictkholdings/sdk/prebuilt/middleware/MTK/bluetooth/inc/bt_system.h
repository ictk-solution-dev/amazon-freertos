...
#define BT_CONTROL_BLOCK_SIZE_OF_LE_CONNECTION    (104)    /**< The size of a control block for Bluetooth LE connection. */
#define BT_CONTROL_BLOCK_SIZE_OF_EDR_CONNECTION   (72)     /**< The size of a control block for BR/EDR connection. */
...
#define BT_CONTROL_BLOCK_SIZE_OF_AVRCP            (68)     /**< The size of a control block for AVRCP. */
#define BT_CONTROL_BLOCK_SIZE_OF_A2DP_SEP         (16)     /**< The size of a control block for A2DP_SEP. */
#define BT_CONTROL_BLOCK_SIZE_OF_A2DP             (148)    /**< The size of a control block for A2DP. */
...
#define BT_CONTROL_BLOCK_SIZE_OF_AWS              (100)    /**< The size of a control block for AWS. */
#define BT_CONTROL_BLOCK_SIZE_OF_HID              (100)    /**< The size of a control block for HID. */
#define BT_CONTROL_BLOCK_SIZE_OF_GATT             (32)     /**< The size of a control block for GATT. */
#define BT_CONTROL_BLOCK_SIZE_OF_AWS_MCE          (100)    /**< The size of a control block for AWS_MCE. */
#define BT_CONTROL_BLOCK_SIZE_OF_HSP              (52)     /**< The size of a control block for GATT. */
#define BT_CONTROL_BLOCK_SIZE_OF_AVRCP_EX         (160)    /**< The size of a control block for AVRCP BROWSE CHANNEL. */
 ...
 */
typedef struct {
    uint16_t dpc_value;      /**< modern digtal power control value */
 ...
 */
typedef enum {
    BT_POWER_RESET_SW = 1,     /**< Bluetooth hardware power reset. */
    BT_POWER_RESET_HW          /**< Bluetooth software power reset. */
} bt_power_reset_t;
/**
 * @}
 */
...
/**
 * @brief     This function is used to set the local public address when bt is in powerd off state.
 * @param[in] public_addr   is a pointer to a given public address (6 bytes), it can't be NULL.
 *                   It will be taken effect on next bt power on.
 * @return    #BT_STATUS_SUCCESS, the operation success.
 *            #BT_STATUS_FAIL, the operation fails. because the Bluetooth is not in powerd off state or parameter public_addr is NULL.
 */
