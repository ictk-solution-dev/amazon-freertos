...
* @param[in] handle is the gap conneciton handle for Agent or Sigle headset, or the 
*                      AWS conneciton handle for Partner and Client role.
...
/**
* @brief               This function reqeusts BT Controller to enable or disable
...
* @return              None.
*/
void bt_avm_set_N9_3M_flag(bool enable);
