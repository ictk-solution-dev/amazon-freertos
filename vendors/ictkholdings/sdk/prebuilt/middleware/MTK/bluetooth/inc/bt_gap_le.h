...
typedef struct {
    ...
    uint16_t                        connection_handle;                          /**< The connection handle which indicate the advertising termincated due to a connection had been established by the advertising. */
 ...
 *         has recevied a scan request from remote device.
 */
BT_PACKED (
typedef struct {
 ...
 *         Channel selectioin algorithm indication, an event sent to the application indicates
...
typedef struct {
    bt_gap_le_advertising_handle_t  handle; /**< Advertising handle. */
    bt_hci_enable_t clear_all;              /**< All advertising handle cleard flag, #BT_HCI_ENABLE means all advertsing handle had cleard. */
...
typedef struct {
    ...
    uint8_t      fragment_preference;   /**< 0x00 means controller may fragment all host advertising data, 0x01 means controller should not fragment or should minimize fragmentation of host advertising data. All ohter values reserved. */
 ...
 *               #BT_STATUS_FAIL, the opeation is excuting, please retry after the event #BT_GAP_LE_READ_PHY_CNF had been received.
 *               #BT_STATUS_OUT_OF_MEMORY, out of memory.
 */
 ...
 * @return    #BT_STATUS_SUCCESS, the operation completed successfully, otherwise it failed.
 *               #BT_STATUS_UNSUPPORTED, the operation not supported on this version.
 *               #BT_STATUS_FAIL, the opeation is excuting, please retry after the event #BT_GAP_LE_SET_PHY_CNF had been received.
 *               #BT_STATUS_OUT_OF_MEMORY, out of memory.
 */
 ...
 * @param[in] handle        is the advertisng handle which is indicated when call #bt_gap_le_config_extended_advertising.
 * @param[in] enable        indicate enable or disable a advertising, it can trigger again to change advertising timing even if advertising is enabled.
 * @return    #BT_STATUS_SUCCESS, the operation completed successfully, otherwise it failed.
 *               #BT_STATUS_UNSUPPORTED, the operation not supported on this version.
 *               #BT_STATUS_FAIL, the opeation is excuting or the paramters are invalid, please retry after the event #BT_GAP_LE_ENABLE_EXTENDED_ADVERTISING_CNF had been received, or check the parameters are valid.
 *               #BT_STATUS_OUT_OF_MEMORY, out of memory.
 */
...
/**
 * @brief     This function creates or configures or changes a extended advertising indicated by handle.
 ...
 *            The extended advertising paramters is mandatory if the advertising indicated by the handle had not been created before.
 *            A new advertising handle will be created if the handle had not been created before.
 *            The stack will not apply advertising set extended advertising parameter if extended advertising parameters is NULL.
 ...
 * @param[in] handle        is the extended advertisng handle.
 * @param[in] random_addr        is the extended advertising random address,  it can't change when advertising is enabled.
 * @param[in] param        is the extended advertising paramters, it can't change when advertising is enabled.
 ...
 * @return    #BT_STATUS_SUCCESS, the operation completed successfully, otherwise it failed.
 *               #BT_STATUS_UNSUPPORTED, the operation not supported on this version.
 *               #BT_STATUS_FAIL, the opeation is excuting or the paramters are invalid, please retry after the event #BT_GAP_LE_CONFIG_EXTENDED_ADVERTISING_CNF had been received, or check the parameters are valid.
 *               #BT_STATUS_OUT_OF_MEMORY, out of memory.
 */
 ...
 * @return    #BT_STATUS_SUCCESS, the operation completed successfully, otherwise it failed.
 *               #BT_STATUS_UNSUPPORTED, the operation not supported on this version.
 *               #BT_STATUS_FAIL, the opeation is excuting or the paramters are invalid, please retry after the event #BT_GAP_LE_REMOVE_ADVERTISING_CNF or check the parameters are valid.
 *               #BT_STATUS_OUT_OF_MEMORY, out of memory.
 */
 ...
 * @param[in] params      is a pointer to the extended scan paramters, it can be NULL
 * @param[in] enable     is a switch for the scanner to enable or disable or change the timing of scanning, it can be NULL.
 * @return    #BT_STATUS_SUCCESS, the operation completed successfully, otherwise it failed.
 *               #BT_STATUS_UNSUPPORTED, the operation not supported on this version.
 *               #BT_STATUS_FAIL, the opeation is excuting or the paramters are invalid, please retry after the event #BT_GAP_LE_SET_EXTENDED_SCAN_CNF or check the parameters are valid.
 *               #BT_STATUS_OUT_OF_MEMORY, out of memory.
 */
