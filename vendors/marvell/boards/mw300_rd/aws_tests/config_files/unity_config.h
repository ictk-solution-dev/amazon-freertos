...
/* #define UNITY_OUTPUT_CHAR(a)                    wm_putchar(a) */
/* #define UNITY_OUTPUT_CHAR_HEADER_DECLARATION    wm_putchar(int) */
/* #define UNITY_OUTPUT_FLUSH()                    wm_flush() */
/* #define UNITY_OUTPUT_FLUSH_HEADER_DECLARATION   wm_flush(void) */
/* #define UNITY_OUTPUT_START()                    init_uart() */
/* #define UNITY_OUTPUT_COMPLETE()                 deinit_uart() */
